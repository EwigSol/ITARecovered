    ...
    <table cellspacing="0" width="100%">
        <tr>
            ...
            <td style="text-aligh:center">
                    ...
                    class="text-white mb-0"> {{isset(generalSetting()->school_name)?generalSetting()->school_name:'ITA School Management ERP'}} </h3>
                    <span style="font-size:11px !important;margin:0px"
                    class="text-white "> {{isset(generalSetting()->address)?generalSetting()->address:'ITA School Address'}} </span>
