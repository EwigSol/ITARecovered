                        ...
                        <ul class="nav navbar-nav mr-auto nav-buttons flex-sm-row">
                            @if (Auth::user()->role_id !=10)
                              ...
                              @endif
                                    @if (Auth::user()->role_id ==10)
                                        <li class="nav-item">
                                          <button type="button" class="primary-btn white modal_btn" data-toggle="modal" data-target="#myModal">
                                        Schools
                                        </button>
                                        </li>
                                    @endif
                          ...
                          <div class="col-lg-12">
                                <div class="input-effect">
                                     <select name="school_name" onchange="get_school(this);" class="niceSelect w-100 bb form-control {{ $errors->has('school_name') ? ' is-invalid' : '' }}" id="school_name">
                                        ...
                                        <?php $sm_staf = DB::table('sm_staffs')->where(['role_id'=>Auth::user()->role_id,'user_id'=>Auth::user()->id])->pluck('district_idFk');?>
                                        <?php $school_info=DB::table('sm_schools')->whereIn('district_idFk',$sm_staf)->where('active_status',1)->get(); ?>
                                            ...
                                            <ul class="list-unstyled">
                                                <li>
                                                    ...
                                                    @elseif(Auth::user()->role_id != "3" && Auth::user()->is_saas == 0)
                                                        ...
                                                        <a href="{{route('viewStaff', isset(Auth::user()->staff->id))}}">
                                                            <span class="ti-user"></span>
                                                            @lang('common.view_profile')
                                                        </a>
