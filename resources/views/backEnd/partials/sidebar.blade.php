...
<nav id="sidebar">
    ...
    <?php $sm_staf = DB::table('sm_staffs')->select('district_idFk')->where(['role_id'=>Auth::user()->role_id,'user_id'=>Auth::user()->id])->first();

        $infix_permission_assigns =  DB::table('infix_permission_assigns')->where(['role_id'=>Auth::user()->role_id,'district_idFk'=>$sm_staf->district_idFk])->first(); ?>
  
    @if(empty($infix_permission_assigns->school_id)  && Auth::user()->role_id == 10)
        ...
        <ul class="list-unstyled components" id="sidebar_menu">
                            ...
                            <a href="{{route('superadmin-dashboard')}}" id="superadmin-dashboard">
                                @else
                                    <a href="{{route('admin-dashboard')}}" id="admin-dashboard">
                                        @endif
                                        <span class="flaticon-speedometer"></span>@lang('common.dashboard')
                                    </a>
                    </li>
                @endif
            @endif
            ...
            @else
                ...
                @if(Auth::user()->role_id != 2 && Auth::user()->role_id != 3 )
                    ...
                    @endif
                    <!-- school registration -->
                    @if(userPermission(4009) && menuStatus(4009))
                        <li data-position="{{menuSchoolPosition(4009)}}" class="sortable_li">
                            <a href="#subMenuSchoolAdmin" data-toggle="collapse" aria-expanded="false"
                               class="dropdown-toggle">
                                <span class="flaticon-analytics"></span>
                                @lang('Schools')
                            </a>
                            <ul class="collapse list-unstyled" id="subMenuSchoolAdmin">
                                @if(userPermission(4010) && menuStatus(4010))
                                    <li data-position="{{menuSchoolPosition(4010)}}">
                                        <a href="{{route('createSchool')}}">@lang('school Registration')</a>
                                    </li>
                                @endif
                                @if(userPermission(4011) && menuStatus(4011))
                                    <li data-position="{{menuSchoolPosition(4011)}}">
                                        <a href="{{route('school-Information')}}">@lang('School List')</a>
                                    </li>
                                @endif
                    ...
                    @endif
                    @if(userPermission(4001) && menuStatus(4001))
                        <li>
                            <a href="{{route('program_module')}}" id="admin-dashboard">
                                 
                                <span class="flaticon-speedometer"></span>@lang('Programs')
                            </a>
                        </li>
                    @endif
                    <!-- end -->
                            ...
                            <ul class="collapse list-unstyled" id="subMenuStudent">
                                @if(userPermission(71) && menuStatus(71))
                                    <li data-position="{{menuPosition(71)}}">
                                        <a href="{{route('student_category')}}"> @lang('student.student_category')</a>
                                    </li>
                                @endif
                                ...
                                @if(userPermission(70)  && menuStatus(70))
                                    <li data-position="{{menuPosition(70)}}">
                                        <a href="{{route('student_attendance_report')}}"> @lang('student.student_attendance_report')</a>
                                    </li>
                                @endif
                                @if(userPermission(533)  && menuStatus(533))
                                    <li data-position="{{menuPosition(533)}}">
                                        <a href="{{route('subject-wise-attendance')}}"> @lang('student.subject_wise_attendance') </a>
                                    </li>
                                @endif
                                @if(userPermission(535)  && menuStatus(535))

                                    <li data-position="{{menuPosition(535)}}">
                                        <a href="{{url('subject-attendance-average-report')}}"> @lang('student.subject_attendance_report')</a>
                                    </li>
                                @endif
                    ...
                    @if(userPermission(245)  && menuStatus(245))
                        <li data-position="{{menuPosition(245)}}" class="sortable_li">
                            <a href="#subMenuAcademic" data-toggle="collapse" aria-expanded="false"
                               class="dropdown-toggle">
                            ...
                            <ul class="collapse list-unstyled" id="subMenuAcademic">
                                @if(userPermission(537) && menuStatus(537))
                                    <li data-position="{{menuPosition(537)}}">
                                        <a href="{{route('optional-subject')}}"> @lang('academics.optional_subject') </a>
                                    </li>
                                @endif
                                ...
                                @if(userPermission(253) && menuStatus(253))
                                    <li data-position="{{menuPosition(253)}}">
                                        <a href="{{route('assign-class-teacher')}}"> @lang('academics.assign_class_teacher')</a>
                                    </li>
                                @endif
                                ...
                                @if(Auth::user()->role_id != 4)
                                    @if(userPermission(387) && menuStatus(387))
                                        <li data-position="{{menuPosition(387)}}">
                                            <a href="{{route('teacher_class_routine_report')}}">@lang('academics.teacher_class_routine')</a>
                                        </li>
                                    @endif
                                @endif
                            <!-- only for teacher -->
                    ...
                    @if(userPermission(800) && menuStatus(800))
                        <li data-position="{{menuPosition(800)}}" class="sortable_li">
                            <a href="#subMenuTeacherLesson" data-toggle="collapse" aria-expanded="false"
                               class="dropdown-toggle">
                                <span class="flaticon-professor"></span>
                            ...
                            <ul class="collapse list-unstyled" id="subMenuTeacherLesson">
                                ...
                                @if(userPermission(809) && menuStatus(809))
                                    <li data-position="{{menuPosition(809)}}">
                                        <a href="{{route('topic-overview')}}"> @lang('lesson::lesson.topic_overview')</a>
                                    </li>
                                @endif
                                @if(userPermission(810) && menuStatus(810))
                                    <li data-position="{{menuPosition(810)}}">
                                        <a href="{{route('lesson.lesson-planner')}}"> @lang('lesson::lesson.lesson_plan')</a>
                                    </li>
                                @endif

                                @if(userPermission(815) && menuStatus(815) )
                                    <li data-position="{{menuPosition(815)}}">
                                        <a href="{{route('lesson.lessonPlan-overiew')}}"> @lang('lesson::lesson.lesson_plan_overview')</a>
                                    </li>
                                @endif
                                @if(Auth::user()->role_id == 4)
                                    <li>
                                        <a href="{{route('view-teacher-lessonPlan')}}">@lang('lesson::lesson.my_lesson_plan') </a>
                                    </li>
                                    <li>
                                        <a href="{{route('view-teacher-lessonPlan-overview')}}">@lang('lesson::lesson.my_lesson_plan_overview')</a>
                                    </li>
                                @endif
                                    ...
                                    <ul class="collapse list-unstyled" id="subMenuFeesCollection">
                                        ...
                                        @if(userPermission(113) && menuStatus(113))
                                            <li data-position="{{menuPosition(113)}}">
                                                <a href="{{route('search_fees_payment')}}"> @lang('fees.search_fees_payment')</a>
                                            </li>
                                        @endif
                                        @if(userPermission(116) && menuStatus(116))
                                            <li data-position="{{menuPosition(116)}}">
                                                <a href="{{route('search_fees_due')}}"> @lang('fees.search_fees_due')</a>
                                            </li>
                                        @endif
                                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="subMenuAccount">
                                @if(userPermission(148) && menuStatus(148))
                                    <li data-position="{{menuPosition(148)}}">
                                        <a href="{{route('chart-of-account')}}"> @lang('accounts.chart_of_account')</a>
                                    </li>
                                @endif
                                ...
                                @endphp
                                    <li data-position="{{menuPosition(700)}}">
                                        <a href="#subMenuAccountReport" data-toggle="collapse" aria-expanded="false"
                                           class="dropdown-toggle {{ spn_nav_item_open($subMenuAccount, 'active') }}">
                                            @lang('reports.report')
                                        </a>
                                        <ul class="collapse list-unstyled {{ spn_nav_item_open($subMenuAccount, 'show') }}" id="subMenuAccountReport">
                                            @if(userPermission(701) && menuStatus(701))
                                                <li>
                                                    <a href="{{route('fine-report')}}"> @lang('accounts.fine_report')</a>
                                                </li>
                                            @endif
                                            @if(userPermission(702) && menuStatus(702))
                                                <li>
                                                    <a href="{{route('accounts-payroll-report')}}"> @lang('accounts.payroll_report')</a>
                                                </li>
                                            @endif
                                            @if(userPermission(703) && menuStatus(703))
                                                <li>
                                                    <a href="{{route('transaction')}}"> @lang('accounts.transaction')</a>
                                                </li>
                                            @endif
                                        </ul>
                                    </li>
                            ...
                            <ul class="collapse list-unstyled" id="subMenuHumanResource">
                                ...
                                @if(userPermission(169) && menuStatus(169))
                                    <li data-position="{{menuPosition(169)}}">
                                        <a href="{{route('staff_attendance_report')}}"> @lang('hr.staff_attendance_report')</a>
                                    </li>
                                @endif
                    ...
                    @if(userPermission(1100) && menuStatus(1100))
                        <li data-position="{{menuPosition(1100)}}" class="sortable_li">
                            <a href="#subMenuCustomField" data-toggle="collapse" aria-expanded="false"
                               class="dropdown-toggle">
                                <span class="flaticon-slumber"></span>
                            ...
                            <ul class="collapse list-unstyled" id="subMenuExam">
                                ...
                                @if(userPermission(229) && menuStatus(229))
                                    <li data-position="{{menuPosition(229)}}">
                                        <a href="{{route('send_marks_by_sms')}}"> @lang('exam.send_marks_by_sms')</a>
                                    </li>
                                @endif
                                ...
                                @if(userPermission(436) && menuStatus(436) || userPermission(706) && menuStatus(706))
                                    ...
                                    <li>
                                        <a href="#examSettings" data-toggle="collapse" aria-expanded="false"
                                           class="dropdown-toggle {{ spn_nav_item_open($subMenuExam, 'active') }}">
                                            @lang('exam.settings')
                                        </a>
                                        <ul class="collapse list-unstyled {{ spn_nav_item_open($subMenuExam, 'show') }}" id="examSettings">
                                            @if(userPermission(436) && menuStatus(436))
                                                <li data-position="{{menuPosition(436)}}">
                                                    <a href="{{route('custom-result-setting')}}">@lang('exam.setup_exam_rule')</a>
                                                </li>
                                            @endif
                            ...
                            <ul class="collapse list-unstyled" id="subMenuHomework">
                                ...
                                @if(userPermission(284) && menuStatus(284))
                                    <li data-position="{{menuPosition(284)}}">
                                        <a href="{{route('evaluation-report')}}"> @lang('homework.evaluation_report')</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
                            ...
                            <ul class="collapse list-unstyled" id="subMenuCommunicate">
                                ...
                                @if(userPermission(291) && menuStatus(291))
                                    <li data-position="{{menuPosition(291)}}">
                                        <a href="{{route('send-email-sms-view')}}">@lang('communicate.send_email')</a>
                                    </li>
                                @endif
                                ...
                                @if(userPermission(710) && menuStatus(710))
                                    <li data-position="{{menuPosition(710)}}">
                                        <a href="{{route('templatesettings.sms-template')}}">@lang('communicate.sms_template')</a>
                                    </li>
                                @endif
                            ...
                            <ul class="collapse list-unstyled" id="subMenulibrary">
                                @if(userPermission(304) && menuStatus(304))
                                    <li data-position="{{menuPosition(304)}}">
                                        <a href="{{route('book-category-list')}}"> @lang('library.book_category')</a>
                                    </li>
                                @endif
                            ...
                            <ul class="collapse list-unstyled" id="subMenuTransport">
                                ...
                                @if(userPermission(361) && menuStatus(361))
                                    <li data-position="{{menuPosition(361)}}">
                                        <a href="{{route('student_transport_report')}}"> @lang('transport.student_transport_report')</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
                            ...
                            <ul class="collapse list-unstyled" id="subMenuDormitory">
                                ...
                                @if(userPermission(375) && menuStatus(375))
                                    <li data-position="{{menuPosition(375)}}">
                                        <a href="{{route('student_dormitory_report')}}"> @lang('dormitory.student_dormitory_report')</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
                    @endif
                    @if(userPermission(4013) && menuStatus(4013))
                        <li data-position="{{menuPosition(4013)}}" class="sortable_li">
                            <a href="{{route('district_module')}}" id="admin-dashboard">
                                 
                                <span class="flaticon-speedometer"></span>@lang('district')
                            </a>
                        </li>
                    @endif
                            ...
                            <ul class="collapse list-unstyled" id="subMenusystemReports">
                                ...
                                @if(userPermission(539) && menuStatus(539))
                                    <li data-position="{{menuPosition(539)}}">
                                        <a href="{{route('previous-class-results')}}">@lang('reports.previous_result') </a>
                                    </li>
                                @endif
                                ...
                                @if(Auth::user()->role_id == 1)
                                    @if(moduleStatusCheck('ResultReports')== TRUE)
                                        {{-- ResultReports --}}
                                        <li>
                                            <a href="{{route('resultreports/cumulative-sheet-report')}}">@lang('reports.cumulative_sheet_report')</a>
                                        </li>
                                        <li>
                                            <a href="{{route('resultreports/continuous-assessment-report')}}">@lang('lang.contonuous_assessment_report')</a>
                                        </li>
                                        <li>
                                            <a href="{{route('resultreports/termly-academic-report')}}">@lang('lang.termly_academic_report')</a>
                                        </li>
                                        <li>
                                            <a href="{{route('resultreports/academic-performance-report')}}">@lang('lang.academic_performance_report')</a>
                                        </li>
                                        <li>
                                            <a href="{{route('resultreports/terminal-report-sheet')}}">@lang('lang.terminal_report_sheet')</a>
                                        </li>
                                        <li>
                                            <a href="{{route('resultreports/continuous-assessment-sheet')}}">@lang('lang.continuous_assessment_sheet')</a>
                                        </li>
                                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="subMenusystemSettings">
                                ...
                                @if((moduleStatusCheck('Saas')== TRUE) && (auth()->user()->is_administrator=="yes"))
                                    @if(userPermission(405)  && menuStatus(405))
                                        <li data-position="{{menuPosition(405)}}">
                                            <a href="{{route('school-general-settings')}}"> @lang('system_settings.general_settings')</a>
                                        </li>
                                    @endif
                                @else
                                    @if(userPermission(405)  && menuStatus(405))
                                        ...
                                        <li data-position="{{menuPosition(405)}}">
                                            <a href="{{route('general-settings')}}"> @lang('system_settings.general_settings')</a>
                                        </li>
                                    @endif
                                @endif
                                ...
                                @if (userPermission(463) && menuStatus(463))
                                    <li data-position="{{ menuPosition(463) }}">
                                        <a href="{{ route('button-disable-enable') }}">@lang('system_settings.dashboard_setup') </a>
                                    </li>
                                @endif
                            ...
                            <ul class="collapse list-unstyled" id="subMenufrontEndSettings">
                                ...
                                @if(userPermission(500)  && menuStatus(500))
                                    <li data-position="{{menuPosition(500)}}">
                                        <a href="{{route('news-category')}}">@lang('front_settings.news') @lang('student.category')</a>
                                    </li>
                                @endif
                                ...
                                @if(userPermission(529) && menuStatus(529))
                                    <li data-position="{{menuPosition(529)}}">
                                        <a href="{{route('social-media')}}"> @lang('front_settings.social_media') </a>
                                    </li>
                                @endif
                                ...
                                @if(userPermission(527) && menuStatus(527))
                                    <li data-position="{{menuPosition(527)}}">
                                        <a href="{{route('custom-links')}}"> @lang('front_settings.footer_widget') </a>
                                    </li>
                                @endif
                            </ul>
                        </li>
