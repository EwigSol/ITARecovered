...
<body onLoad="loadHandler();">
    <div class="invoice_wrapper">
                            ...
                            <td>
                                <div class="logo_img">
                                    ...
                                    <div class="company_info">
                                        <h3>{{isset(generalSetting()->school_name)?generalSetting()->school_name:'ITA School Management ERP'}}</h3>
                                        <h5>{{isset(generalSetting()->address)?generalSetting()->address:'ITA School Address'}}</h5>
                                        <h5>
                                            @lang('common.email'): {{isset(generalSetting()->email)?generalSetting()->email:'admin@itacec.org'}},
        ...
        <table class="table gray_header_table mb-0 border_table" >
            ...
            @endforeach
            <tr>
              <td colspan="6"><strong>@lang('exam.additional_subject')</strong></td>
              <td colspan="5"></td>
            </tr>
            @foreach($mark_sheet as $data)
            @php
        ...
        <table class="table border_table gray_header_table mb_30 max-width-400 ml_auto margin-auto report_table">
          <tbody>
            ...
            <tr>
              <td class="nowrap">@lang('exam.without_optional')</td>
                <td class="nowrap"> 
                    @php
