    ...
    <section class="sms-breadcrumb mb-40 white-box up_breadcrumb">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>@lang('School List')</h1>
                <div class="bc-pages">
                    <a href="{{route('dashboard')}}">@lang('common.dashboard')</a>
                    <a href="#">@lang('admin.admin_section')</a>
                    <a href="#">@lang('School List')</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-md-right col-md-6 mb-30-lg col-6 text-right ">
                    @if(userPermission(13))
                        <a class="primary-btn-small-input primary-btn small fix-gr-bg" href="{{route('createSchool')}}"
                                 >
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0">@lang('School List')</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                @foreach($registration_query as $key=>$admission_query)
                                    <tr>
                                        <td>{{@$key+1}}</td>
                                        <td>{{@$admission_query->school_name}}</td>
                                        <!-- <td>{{@$admission_query->site_title}}</td> -->
                                        <td>{{@$admission_query->school_code }}</td>
                                        <td>{{@$admission_query->address}} </td>
                                        <td>
                                            {{@$admission_query->email}}
                                        </td>
                                  <!--       <td >
                                            {{@$admission_query->currency_symbol }}</td> -->
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item  "  
                                                           href="{{route('school-view', [$admission_query->id])}}">@lang('common.edit')</a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-40 d-flex justify-content-between">
                                                        ...
                                                        {{ Form::open(['route' => 'school_registration_delete', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
