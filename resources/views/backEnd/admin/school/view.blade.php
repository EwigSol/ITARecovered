                ...
                <!-- <div class="row">
                    ...
                    @else
                        @if(userPermission(406))
                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => ['update-logo',$id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                        @endif
                    @endif
                    ...
                    @endif
                        ...
                        <div class="white-box">
                            ...
                            @if(isset($editData->favicon) && !empty(@$editData->favicon))                            
                                <img class="img-fluid Img-50"  src="{{asset($editData->favicon)}} " alt="" >
                            @else
                ...
                <div class="row xm_3">
                    ...
                    <div class=" col-lg-5 col-xl-5 text-right col-md-6 col-sm-6 sm2_10">
                        @if(userPermission(408))
                            <a href="{{route('createSchool',$id)}}" class="primary-btn small fix-gr-bg "> <span class="ti-pencil-alt"></span> @lang('common.edit')
                        </a>
                        @endif
                    </div>
                </div>
                              ...
                              <!--   <div class="single-meta">
                                ...
                                <div class="single-meta">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="value text-left">
                                                @if(isset($editData->copyright_text))
