                        ...
                        <div class="permission_header d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                ...
                                <label for="Main_Module_{{$key}}">
                                    @if($module_info->name=='Programs' || $module_info->name=='Schools' ||$module_info->name=='District'){{__( $module_info->name)}}
                                     
                                    @else{{__('rolepermission::permissions.'.$module_info->name)}}@endif</label>
                            </div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="submodule">
                                            ...
                                            <label for="Sub_Module_{{$row2->id}}">
                                                @if($row2->name=='Schools Registration')
                                                {{__($row2->name)}}
                                                @elseif($row2->name=='Schools List')
                                                {{__($row2->name)}}
                                                @else{{__('rolepermission::permissions.'.$row2->name)}}@endif</label>
                                            <br>
                                        </div>
