    ...
    public function rolePermissionAssign(Request $request)
    {
        ...
        try {
            ...
            if ($request->district_id && $request->district_id!='') {
                InfixPermissionAssign::where('district_idFk', $request->district_id)->where('role_id', $request->role_id)->delete();
            }else{
                InfixPermissionAssign::where('school_id', $request->school_id)->where('role_id', $request->role_id)->delete();
            }
            ...
            if ($request->module_id) {
                ...
                foreach ($request->module_id as $module) {
                    ...
                    if ($request->district_id && $request->district_id!='') {
                        $assign->district_idFk = $request->district_id;
                    }else{
                        $assign->school_id = $request->school_id;
                    }
                    $assign->save();
                }
            }
