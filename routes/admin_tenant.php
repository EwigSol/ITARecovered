...
Route::group(['middleware' => ['XSS','subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        Route::get('schoolModule-dashboard', 'HomeController@schoolModule')->name('schoolModule-dashboard');
        Route::post('districtPermissionUpdate', 'HomeController@districtPermissionUpdate')->name('districtPermissionUpdate');
        //Role Setup
        ...
        Route::get('district_module', 'DistrictController@index')->name('district_module')->middleware('userRolePermission:4013');
        Route::get('program_module', 'ProgramController@index')->name('program_module')->middleware('userRolePermission:4001');
        Route::post('program_submit', 'ProgramController@store')->name('program_submit')->middleware('userRolePermission:376');
        Route::get('program/{id}', 'ProgramController@show')->name('program-edit')->middleware('userRolePermission:4001');
        Route::put('program-update/{id}', 'ProgramController@update')->name('program-update')->middleware('userRolePermission:4001');
        Route::delete('program-delete/{id}', 'ProgramController@destroy')->name('program-delete')->middleware('userRolePermission:376');
        Route::post('district_submit', 'DistrictController@store')->name('district_submit')->middleware('userRolePermission:376');
        Route::get('district/{id}', 'DistrictController@show')->name('district-edit')->middleware('userRolePermission:4013');
        Route::put('district-update/{id}', 'DistrictController@update')->name('district-update')->middleware('userRolePermission:4013');
        Route::delete('district-delete/{id}', 'DistrictController@destroy')->name('district-delete')->middleware('userRolePermission:376');
        ...
        Route::get('staff_directory_listing/{type?}', ['as' => 'staff_directory_listing', 'uses' => 'Admin\Hr\SmStaffController@staffListReportxlsx'])->middleware('userRolePermission:161');
        ...
        Route::get('createSchool/{id?}', 'Admin\SchoolRegisteration\RegisterationController@createSchool')->name('createSchool')->middleware('userRolePermission:4010');
        Route::post('add-school-registration', 'Admin\SchoolRegisteration\RegisterationController@store')->name('add-school-registration')->middleware('userRolePermission:4011');
        Route::get('school-view/{id?}', 'Admin\SchoolRegisteration\RegisterationController@View')->name('school-view')->middleware('userRolePermission:4011');
        Route::any('school_registration_delete', 'Admin\SchoolRegisteration\RegisterationController@delete')->name('school_registration_delete')->middleware('userRolePermission:4011');
        Route::any('update-logo/{id?}', 'Admin\SchoolRegisteration\RegisterationController@SchoolLogo')->name('update-logo')->middleware('userRolePermission:406');
        Route::any('edit-school-registration/{id?}', 'Admin\SchoolRegisteration\RegisterationController@edit')->name('edit-school-registration')->middleware('userRolePermission:406');
         
        Route::get('school-Information', 'Admin\SchoolRegisteration\RegisterationController@index')->name('school-Information')->middleware('userRolePermission:4011');
