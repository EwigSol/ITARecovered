                            ...
                            <div class="single-report-admit">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex">
                                            ...
                                            <div class="col-lg-6 ml-30">
                                                <h3 class="text-white"> {{isset(generalSetting()->school_name)?generalSetting()->school_name:'ITA School Management ERP'}} </h3> 
                                                <p class="text-white mb-0"> {{isset(generalSetting()->address)?generalSetting()->address:'ITA School Address'}} </p>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h3 class="primary-color fw-500 text-center">@lang('reports.merit_list')</h3>
