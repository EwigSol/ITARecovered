...
class SmHomeworkController extends Controller
{
    ...
    public function addHomework()
    {
        try {
            ...
            return view('backEnd.homework.addHomework', compact('classes','sm_stuff','role_id','districts'));
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
    ...
    public function saveHomeworkData(SmHomeworkRequest $request)
    {
        ...
        try {
            ...
            foreach($request->section_id as $section){
                ...
                $homeworks->district_idFk = $request->district_name;
                $homeworks->school_id = $request->school_name;
