...
class SmStudentAdmissionController extends Controller
{
    ...
    public function store(SmStudentAdmissionRequest $request)
    {
        ...
        try {
            ...
            $user_stu->school_id = $request->school_name;
            ...
            if ($request->parent_id == "") {
                ...
                $user_parent->school_id = $request->school_name;
                ...
                $parent->school_id = $request->school_name;
            ...
            $student->district_idFk = $request->district_name;
            $student->school_id = $request->school_name;
            $student->program_Fk = $request->program_name;
